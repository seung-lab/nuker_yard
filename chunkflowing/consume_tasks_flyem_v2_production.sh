...
export NETOUTPUT_PATH="matrix://fafbv14-aff/nucleus/v4"

export OUTPUT_PATH="matrix://fafbv14-aff/nucleus/v4_z_intp"

export OUTPUT1_LAYER_PATH="matrix://fafbv14-aff/nucleus/v4_z_intp_intp"
export OUTPUT2_LAYER_PATH="matrix://fafbv14-aff/nucleus/v4_z_intp_blur"

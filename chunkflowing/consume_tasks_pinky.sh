...
export BASE_PATH="gs://neuroglancer/pinky100_v0"
export IMAGE_LAYER_PATH="$BASE_PATH/son_of_alignment_v15_rechunked"
export NETOUTPUT_PATH="$BASE_PATH/nucleus/net-output"
...
export VISIBILITY_TIMEOUT="1800" # GCP ~1800s w 4 parallel, 1350 w 3, on T4. 3400s w 3 on K80. AWS T4 just 500s single 
...
# export QUEUE_NAME="chunkflow-shang"
	...
	#generate-task --offset 1 2677 2187 --shape 128 1280 1280 \

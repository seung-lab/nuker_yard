...
export CONVNET_WEIGHT_NAME="rsu3.5m2_model6104000.chkpt"

#export CONVNET_WEIGHT_NAME="model.chkpt"



export IMAGE_LAYER_PATH="matrix://minnie65/aligned_image"
export NETOUTPUT_PATH="s3://minnie65-phase2-nuclei/net-output"
...
export VISIBILITY_TIMEOUT="800" # GCP ~1800s w 4 parallel, 1350 w 3, on T4. 3400s w 3 on K80. AWS T4 just 500s single, ~1000s double
